// Write a program which takes 0’s and 1’s as input string and accept that string which have even number of 0’s and odd number of 1’s using the concept of DFA.
...
int main(){
 ...
 if(current_state == final_state) cout<<s<<" is accepted."<<endl;
